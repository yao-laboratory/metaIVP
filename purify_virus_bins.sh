...
python $DIR/python_scripts/purify_contig_bins.py bin_determine -i $bin_fasta_file -b $bins_folder/my_scaffolds2bin.tsv -q $output_path/quality_summary.tsv -d $contig_fasta_summary_file_determined -nd $contig_fasta_summary_file_not_determined -o $output_path
#move this part of checkv to the post processing virus script
#this part has been added to post procesing, double check if variables are passed correctly
