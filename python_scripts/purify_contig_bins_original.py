...
def determine_contigs(contigs_fasta_file,quality_summary,genomad_file,output_directory):
    ...
    contig_fasta_summary_file_determined = pd.merge(contig_fasta_df, new_low_medium_high_df[['contig_id', 'checkv_quality']], on='contig_id', how='inner')
    contig_fasta_summary_file_not_determined = pd.merge(contig_fasta_df, new_not_determined_df[['contig_id', 'checkv_quality']], on='contig_id', how='inner')
